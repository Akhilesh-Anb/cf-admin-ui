...
IdentityZonesTab.prototype.showDetails = function(table, identityZone, row)
{
    ...
    this.addFilterRowIfValue(table, "Identity Providers", Format.formatNumber, row[7], identityZone.id, AdminUI.showIdentityProviders);
    this.addFilterRowIfValue(table, "SAML Providers", Format.formatNumber, row[8], identityZone.id, AdminUI.showServiceProviders);
    this.addFilterRowIfValue(table, "MFA Providers", Format.formatNumber, row[9], identityZone.id, AdminUI.showMFAProviders);
    this.addFilterRowIfValue(table, "Clients", Format.formatNumber, row[10], identityZone.id, AdminUI.showClients);
    this.addFilterRowIfValue(table, "Users", Format.formatNumber, row[11], identityZone.id, AdminUI.showUsers);
    this.addFilterRowIfValue(table, "Groups", Format.formatNumber, row[12], identityZone.id, AdminUI.showGroups);
    this.addFilterRowIfValue(table, "Group Members", Format.formatNumber, row[13], identityZone.id, AdminUI.showGroupMembers);
    this.addFilterRowIfValue(table, "Approvals", Format.formatNumber, row[14], identityZone.id, AdminUI.showApprovals);
};
