...
function StagingSecurityGroupsSpacesTab(id)
{
    Tab.call(this, id, Constants.FILENAME__STAGING_SECURITY_GROUPS_SPACES, Constants.URL__STAGING_SECURITY_GROUPS_SPACES_VIEW_MODEL);
}

StagingSecurityGroupsSpacesTab.prototype = new Tab();

StagingSecurityGroupsSpacesTab.prototype.constructor = StagingSecurityGroupsSpacesTab;

StagingSecurityGroupsSpacesTab.prototype.getColumns = function()
{
    return [
               {
...
StagingSecurityGroupsSpacesTab.prototype.getActions = function()
{
    return [
           ];
};

StagingSecurityGroupsSpacesTab.prototype.clickHandler = function()
{
    this.itemClicked(-1, 0);
};

StagingSecurityGroupsSpacesTab.prototype.showDetails = function(table, objects, row)
{
