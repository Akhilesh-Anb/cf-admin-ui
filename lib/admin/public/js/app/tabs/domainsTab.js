...
DomainsTab.prototype.initialize = function()
{
    ...
    this.domainsOrganizationsTable = Table.createTable("DomainsOrganizations", this.getDomainsOrganizationsColumns(), [[0, "asc"]], null, this.getDomainsOrganizationsActions(), Constants.FILENAME__DOMAIN_ORGANIZATIONS, null, null);
};
