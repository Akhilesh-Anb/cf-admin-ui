...
ServicePlansTab.prototype.showDetails = function(table, objects, row)
{
    ...
    this.addFilterRowIfValue(table, "Service Bindings", Format.formatNumber, row[14], servicePlan.guid, AdminUI.showServiceBindings);
    this.addFilterRowIfValue(table, "Service Keys", Format.formatNumber, row[15], servicePlan.guid, AdminUI.showServiceKeys);
    this.addFilterRowIfValue(table, "Route Bindings", Format.formatNumber, row[16], servicePlan.guid, AdminUI.showRouteBindings);
