...
ServicePlansTab.prototype.showDetails = function(table, objects, row)
{
    ...
    this.addFilterRowIfValue(table, "Service Plan Events", Format.formatNumber, row[11], servicePlan.guid, AdminUI.showEvents);
    this.addFilterRowIfValue(table, "Service Plan Visibilities", Format.formatNumber, row[12], servicePlan.guid, AdminUI.showServicePlanVisibilities);
    this.addFilterRowIfValue(table, "Service Instances", Format.formatNumber, row[13], servicePlan.guid, AdminUI.showServiceInstances);
    this.addFilterRowIfValue(table, "Service Instance Shares", Format.formatNumber, row[14], servicePlan.guid, AdminUI.showSharedServiceInstances);
    this.addFilterRowIfValue(table, "Service Bindings", Format.formatNumber, row[15], servicePlan.guid, AdminUI.showServiceBindings);
    this.addFilterRowIfValue(table, "Service Keys", Format.formatNumber, row[16], servicePlan.guid, AdminUI.showServiceKeys);
    this.addFilterRowIfValue(table, "Route Bindings", Format.formatNumber, row[17], servicePlan.guid, AdminUI.showRouteBindings);
