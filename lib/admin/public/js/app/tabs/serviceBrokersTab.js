...
ServiceBrokersTab.prototype.showDetails = function(table, objects, row)
{
    ...
    this.addFilterRowIfValue(table, "Service Bindings", Format.formatNumber, row[12], serviceBroker.guid, AdminUI.showServiceBindings);
    this.addFilterRowIfValue(table, "Service Keys", Format.formatNumber, row[13], serviceBroker.guid, AdminUI.showServiceKeys);
    this.addFilterRowIfValue(table, "Route Bindings", Format.formatNumber, row[14], serviceBroker.guid, AdminUI.showRouteBindings);
